...
<div>
    <div class="flex flex-row justify-start gap-5 bg-skin-fill shadow-lg m-2 p-2 rounded text-xl">
            <a class="flex flex-row bg-skin-fill-accent shadow-2xl px-2 rounded" href="/">
                <Icon/>
                <p class="align-middle leading-10">Typist</p>
            </a>
            <a class="flex flex-row shadow-2xl px-2 rounded" href="/leaderboard">
                <Trophy/>
                <p class="align-middle leading-10">Leaderboard</p>
            </a>
            <a class="flex flex-row ml-auto shadow-2xl px-2 rounded" href="/profile">
                <Profile/>
